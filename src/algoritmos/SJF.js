export default function SJF(arrayProcesos) {
  ...
  while (!fin) {
    ...
    //11. Si reorder es true, ordenar arrayProcesos por prioridad
    if (reorder) {
      arrayProcesos = orderArrayProcesos(arrayProcesos);
    }
...
function orderArrayProcesos(arrayProcesos) {
  ...
  arrayProcesos.sort((a, b) => a.programa.duracion - b.programa.duracion);
