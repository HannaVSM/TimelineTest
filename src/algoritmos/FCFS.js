...
/*const programa = {
	...
	llegada, //Pulso del reloj en el que entra
	duracion, // duracion del proceso en pulsos de reloj
	bloqueos: [{
		llegada, // instante del proceso en el que entra en bloqueo (No mayor a la duracion del programa)
		duracion, // duracion del bloqueo
	}],
	estadisticas:{
		ejecucion, //tiempo en ejecucion
		espera, //tiempo en espera
		bloqueo, //tiempo en bloqueo
		instante_fin, // Pulso del reloj en el que termina
		retorno, // instante_fin - llegada
		tiempo_perdido, // retorno - ejecucion
		penalidad, // Retorno / ejecucion
		tiempo_respuesta // tiempo que demora en ejecutarse tras haber entrado a la memoria y estar en espera
	},
}

const proceso = {
	programa,
	espera_reciente, //Variable incremental que registra la duracion de la espera mas reciente, apenas cambie el estado se reiniciara.
	counterEjecucion, //contador 
	counterEspera,
	contadoresBloqueos:[] //Array que contiene objetos con el numero de ticks que ha estado bloqueado], 
 	counterNumBloqueo,//contador de cuantos bloqueos ha entrado
	arrayEstados:['Ejecucion', 'Ejecucion', 'Ejecucion', 'Bloqueo', 'Espera'] //Aca se registran los estados en cada paso del reloj
	//Posible estados: Ejecucion, Bloqueo, Espera
	terminado, //Booleano
}
*/
...
// console.log(FCFS(procesos));

export default function FCFS(arrayProcesos) {
  //1. Establecer un array de prioridad por llegada, ordenando los procesos segun llegada (Desde el front ya viene ordenado)
